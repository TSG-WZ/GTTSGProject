...
namespace DTTSG_Web.Areas.Librarian.Controllers
{
    ...
    public class NoticeController : Controller
    {
        ...
        public JsonResult GetNoticePagerData(Notice notify, int pagesize = 10, int pageindex = 1)
        {
        ...
        {
            //List<NoticeType> list = iLibrarianManager.GetNoticeTypeList();
        ...
        /// <returns></returns>
        public JsonResult NoticeSave(Notice model)
        {
            //修改还是添加
